...
Documentation for contributors who want to develop, maintain, or run their own instance of Nepal Entity Service.

## Getting Started

- **[Contributor Guide](contributor-guide.md)** - Setup, development workflow, and contributing
...
This section contains documentation for contributors who want to:
- Set up a local development environment
- Contribute code or data to the project
- Run their own instance of NES
- Understand the internal architecture and services
- Maintain and update entity data

## Just Want to Use the API?

If you only want to consume the public API, check out the [Consumer Documentation](../consumers/).
